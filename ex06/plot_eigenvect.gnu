...
set output sprintf("%s%d%s", "first_", k, "_eigenfunc.pdf")
plot for [i=2:k+1] 'ef_500_0.1E-01_0.5E+01_1.000_1.000.txt' using 1:i with lines title '{/Symbol Y}_{'.(i-1).'}'

set output sprintf("%s%d%s", "first_", k, "_eigenfunc_th.pdf")
plot for [i=2:k+1] 'ef_t_5_500_0.1E-01_0.5E+01_1.000_1.000.txt' using 1:i with lines title '{/Symbol Y}_{th,'.(i-1).'}' 
# lc 0*i dashtype i